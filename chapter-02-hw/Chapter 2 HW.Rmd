...
(a) Describe three real-life applications in which classification might be useful. Describe the response, as well as the predictors. Is the goal of each application inference or prediction? Explain your answer.
    ...
    i. **Sentiment analysis for product reviews**
    
        **Response** : A sentiment label i.e an indicator for Positive, Negative and possibly Neutral reception.
    
        **Predictors** : Possibly predictors can be Text data (review  wording), star ratings, reviewer history
