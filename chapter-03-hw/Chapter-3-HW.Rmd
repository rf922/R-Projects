...
1 \\ \text{GPA}_1 \\ \text{IQ}_1 \\ \text{Level}_1 \\ (\text{GPA} \times \text{IQ})_1 \\ (\text{GPA} \times \text{Level})_1 \\
...
$$
\begin{aligned}
Y &= 50 + 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) + 35 (\text{Level}_1) + 0.01 (\text{GPA} \times \text{IQ})_1 - 10 (\text{GPA} \times \text{Level})_1 \\
&= 50 + 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) + 35(1) + 0.01 (\text{GPA} \times \text{IQ})_1 - 10(\text{GPA} \times \text{Level})_1 
\end{aligned}
$$ 
...
$$
\begin{aligned}
Y &= 50 + 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) + 35 (0) + 0.01 (\text{GPA} \times \text{IQ})_1 - 10 (\text{GPA} \times \text{Level})_1 \\
&= 50 + 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) + 0.01 (\text{GPA} \times \text{IQ})_1 - 10 (\text{GPA} \times \text{Level})_1 
\end{aligned}
$$ 
...
$$
\begin{aligned}
50 + 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) + 35 + 0.01 (\text{GPA} \times \text{IQ})_1 - 10 (\text{GPA} \times \text{Level})_1 &= 50 + 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) + 0.01 (\text{GPA} \times \text{IQ})_1  \\
50 -50 + 20 (\text{GPA}_1) - 20 (\text{GPA}_1) + 0.07 (\text{IQ}_1) - 0.07 (\text{IQ}_1) + 35 + 0.01 (\text{GPA} \times \text{IQ})_1 - 0.01 (\text{GPA} \times \text{IQ})_1 &=  10 (\text{GPA} \times \text{Level})_1 \\
35 &= 10 (\text{GPA} \times \text{Level})_1 \\
3.5 = (\text{GPA} \times \text{Level})_1
\end{aligned}
$$ 
